...
if (isset($_GET['edit_account'])){
    ...
    $row_fetch = mysqli_fetch_assoc($execute);
 ...
 $user_email =$_POST['user_email'];
    ...
    $user_image1=$_FILES['user_image']['name'];
     $user_image_tmp=$_FILES['user_image']['tmp_name'];
        ...
        $execute_update = mysqli_query($con,  $update_data);
        if($execute_update){
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="form-outline mb-4">
            ...
            <img src="./user_images/<?php echo $u_image?>" alt="" class="edit_img">
                   </div>
            ...
            <input type="text" class="form-control w-50 m-auto" value="<?php  echo $user_mobile ?>"  name="user_mobile">
                   ...
                   <input type="submit" value="Update" class="bg-info text-center py-2 px-3 border-0" 
                   name="user_update">
    </form>
</body>
</html>